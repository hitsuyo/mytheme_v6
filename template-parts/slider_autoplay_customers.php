<div id="slider" class="">
  <p  class="control_prev" id="control_prev-ID">&lt;</p> 
  <p  class="control_next" id="control_next-ID">&gt;</p>
  ...
  <ul>
    ...
    <li><img src="http://demo.smnet.vn/quangcaotaxi/wp-content/uploads/2018/08/delivery.jpg" class="responsive-img"></li>
...
<!-- <div class="slider">
  <div class="slide">
    <img src="http://demo.smnet.vn/quangcaotaxi/wp-content/uploads/2018/08/delivery.jpg" width="200px" height="200px" alt="" class="responsive-img" />
    <h1>slide 1</h1>
  </div>
  <div class="slide">
    <img src="http://demo.smnet.vn/quangcaotaxi/wp-content/uploads/2018/08/delivery.jpg" width="200px" height="200px" alt="" class="responsive-img" />
...
div.slider .slide {display: inline; overflow: hidden; }

div.slider .slide img {display: inline;}
...
#slider ul li {display: inline;  float: left; margin-right: 5%;}

#slider ul li img {width: 150px; height: 150px; filter: brightness(70%);}

#slider ul li img:hover {filter: brightness(100%);}
</style>

<style>
    /* p.control_prev {float: left;}
    p.control_next {float: right;}  */

    p.control_prev, p.control_next {
       /* width: 55px; 
       height: 50px; */
    position: absolute;
    top: 35%;
